...
public class FileUploadUtil
{
	 ...
	 * @throws Exception
	 */
	public static Map<String, String> uploadFiles(HttpServletRequest request, MultipartRequest multipartRequest) throws Exception
	{
				...
				if (multiPartFileEntry != null)
				{
					...
					if(multipartFile != null)
					{
						...
						if (fileSize > 0)
						{
							...
							File uploadFolder = new File(uploadBasePath);
